...
app.post("/api/SatuanKerja", function(req, res)
{
  ...
  var query = 'insert into SatuanKerja ( id, id_jns_satker, id_induk_satker, nama, email, create_date, last_update, expired_date ) values( @id, @id_jns_satker, @id_induk_satker, @nama, @email, @create_date, @last_update, @expired_date )';
  executeQuery(res, query, param, 1)
})
